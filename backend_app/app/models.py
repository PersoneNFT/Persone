...
class User(Base):
    ...
    profile_nft_id = Column(Integer, ForeignKey("nfts.id"), nullable=True)  # Profile NFT ID
    is_profile_nft_minted = Column(Boolean, default=False)  # Indicates if profile NFT is minted
